...
var FACTORY_ADDRESSES = (_FACTORY_ADDRESSES = {}, _FACTORY_ADDRESSES[exports.ChainId.WAVE] = '0x1F68F0Ac4Cd9387A0e6eB6F3B894Cb98177AB0a4', _FACTORY_ADDRESSES[exports.ChainId.BITNET] = '0xCba3Dc15Cfbcd900cF8133E39257c26727E86e3a', _FACTORY_ADDRESSES);
var INIT_CODE_HASHES = (_INIT_CODE_HASHES = {}, _INIT_CODE_HASHES[exports.ChainId.WAVE] = '0xc3c90899ffbab4fde73965749d2c0b9462b16a2965a2d1eafc21630dfb68552c', _INIT_CODE_HASHES[exports.ChainId.BITNET] = '0xf06bde01e9762a7025e7a8d8c95d47fc18e8d5fc2588f7dacf399f504b1fedab', _INIT_CODE_HASHES); // exports for internal consumption
...
var WETH = (_WETH = {}, _WETH[exports.ChainId.WAVE] = /*#__PURE__*/new Token(exports.ChainId.WAVE, '0x508aeBc3172eE8FdA7cc746f224C8D9061be7cbd', 18, 'WWAVE', 'Wrapped Wavecoin'), _WETH[exports.ChainId.BITNET] = /*#__PURE__*/new Token(exports.ChainId.BITNET, '0x8148b71232162EA7a0b1c8bFE2b8F023934BFb58', 18, 'WBTN', 'Wrapped Bitnet'), _WETH);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || (input === WAVE || input === BITNET) && pairs[0].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || (output === WAVE || output === BITNET) && pairs[pairs.length - 1].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
function wrappedAmount(currencyAmount, chainId) {
  ...
  if (currencyAmount.currency === WAVE && chainId === exports.ChainId.WAVE || currencyAmount.currency === BITNET && chainId === exports.ChainId.BITNET) return new TokenAmount(WETH[chainId], currencyAmount.raw);
    invariant(false, 'CURRENCY')  ;
}

function wrappedCurrency(currency, chainId) {
  if (currency instanceof Token) return currency;
  if (currency === WAVE && chainId === exports.ChainId.WAVE || currency === BITNET && chainId === exports.ChainId.BITNET) return WETH[chainId];
    invariant(false, 'CURRENCY')  ;
}
/**
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === WAVE && route.chainId === exports.ChainId.WAVE ? CurrencyAmount.wave(amounts[0].raw) : route.input === BITNET && route.chainId === exports.ChainId.BITNET ? CurrencyAmount.bitnet(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === WAVE && route.chainId === exports.ChainId.WAVE ? CurrencyAmount.wave(amounts[amounts.length - 1].raw) : route.output === BITNET && route.chainId === exports.ChainId.BITNET ? CurrencyAmount.bitnet(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
